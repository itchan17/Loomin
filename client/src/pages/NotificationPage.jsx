                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-medium">
                                    <span className="font-semibold text-gray-900">{notification.sender?.first_name} {notification.sender?.last_name}</span>
                                    {' '}wants to follow you
                                </p>
                                <p className="text-sm text-gray-500">{moment(notification.createdAt).fromNow()}</p>
                            </div>
                        </div>
                ...
                <div className="flex-1 min-w-0 border-x border-gray-200 2xl:border-x pb-16 2xl:pb-0">
                    ...
                    <div className="px-6 py-4 border-b border-gray-200">
                        ...
                        <div className="flex items-center gap-2 text-gray-600">
                            ...
                            <span className="text-[#FF6F61] font-medium">{notifications.length} Notifications</span>
                            ...
                            <div className="divide-y divide-gray-200">
                                {notifications.map((notification) => (
                                    <div
                                        ...
                                        className={`px-6 py-4 hover:bg-gray-50 transition ${!notification.read ? 'bg-white bg-opacity-5' : ''
                                            }`}
                                    >
