...
const Header = ({ toggleSidebar }) => {
  ...
  const rederResults = () => {
    ...
    return (
      <div className="absolute rounded-lg bg-white top-full max-h-72 left-0 w-full overflow-y-auto">
        {isSearchLoading ? (
  ...
  return (
    <header className="fixed z-50 flex justify-between items-center h-16 text-black py-4 pl-2 pr-2 md:pl-6 md:pr-8 bg-gradient-to-r from-loomin-yellow to-loomin-orange drop-shadow-md sticky top-0">
      {/* Logo */}
