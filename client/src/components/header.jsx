...
const Header = ({ toggleSidebar }) => {
  return (
    <header
      className="flex justify-between item-center h-16 text-black py-4 pl-2 pr-2 md:pl-6 md:pr-8 
        bg-gradient-to-r from-loomin-yellow to-loomin-orange drop-shadow-md"
      position:sticky
    >
      <button
