          ...
          <div class="divide-y divide-slate-200">
            <div class="flex items-center justify-between pb-3 pt-3 last:pb-0">
              <div class="flex items-center gap-x-3">
                ...
                />
                <div>
                  <h6 class="text-slate-800 font-semibold">Charizard</h6>
                </div>
              </div>
              <button className="bx bxs-user-plus text-loomin-orange text-3xl px-2 hover:bg-orange-100 rounded-full cursor-pointer"></button>
            </div>
            <div class="flex items-center justify-between pb-3 pt-3 last:pb-0">
              <div class="flex items-center gap-x-3">
                <img
                ...
                />
                <div>
                  <h6 class="text-slate-800 font-semibold">Gengar</h6>
                </div>
              </div>
              <button className="bx bxs-user-plus text-loomin-orange text-3xl px-2 hover:bg-orange-100 rounded-full cursor-pointer"></button>
            </div>
