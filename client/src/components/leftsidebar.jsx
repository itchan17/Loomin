...
const Leftsidebar = ({ isOpen }) => {
    return (
      <aside id="sidebar" className={`w-3/12 bg-gradient from-black to-white border-r border-gray-200 h-screen transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0`}>
        <div className="flex flex-col items-center p-6">
          <div className="flex items-center gap-4 mb-4">
            <img src={userImage} alt="User" className="w-24 h-24 rounded-full" />
            <span className="username">getoutofmyswamp</span>
          </div>
          <div className="flex justify-between gap-4 px-2 w-full">
            ...
            <div className="flex flex-col items-center">
              <span className="font-bold text-lg">100.5K</span>
              <span className="text-sm text-gray-600">Followers</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="font-bold text-lg">120K</span>
          ...
          <hr class="h-px my-1` text-emerald-500"></hr>
            ...
            <div className="flex items-center gap-4 px-4 py-2 rounded-lg hover:bg-gradient-to-r hover:from-[#FFD23F] hover:to-[#FF6F61] hover:text-white">
              <img src={notificationIcon} alt="Notifications" className="w-6 h-6 hover:fill-current hover:text-white" />
