    ...
    return (
        <div className="bg-white rounded-2xl shadow-md mb-6 w-full">
            ...
            <div className="relative " onDoubleClick={handleDoubleTap}>
                <img src={placeholder} alt="Post content" className="w-11/12 mx-7 rounded-2xl justify-center" />
            ...
            <div className="p-4 pl-8">
                <div className="flex gap-4">
                    <button onClick={handleLike}>
                        <i className={`bx ${isLiked ? 'bxs-heart text-red-500' : 'bx-heart'} text-2xl`}></i>
                    </button>
